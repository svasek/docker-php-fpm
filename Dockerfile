...
RUN apk add --no-cache --update libcurl freetype libpng libjpeg-turbo memcached unzip curl-dev freetype-dev libpng-dev libjpeg-turbo-dev zlib-dev gettext-dev && \
